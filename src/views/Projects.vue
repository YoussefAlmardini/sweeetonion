<template>
  <v-app>
 <section>
        <div class="page main-bg space-top space-bottom">
            <v-container fluid grid-list-md>
                <div class="text-center">
                    ...
                    special experience to online projects.  Lorem ipsum dolor sit amet, mel at clita quando. Te sit oratio vituperatoribus, nam ad ipsum posidonium mediocritatem, explicari dissentiunt cu mea. Repudiare disputationi vim in, mollis iriure nec cu, alienum argumentum ius ad. Pri eu justo aeque torquatos.
                      ...
                      <v-row dense class="pa-5 mx-auto custom-row width">
                        <v-col
                            v-for="card in projects"
                            :key="card.title"
                            :cols="checkMobile() ? 12 : card.flex"
                        >
                        <v-card>
                            <v-img
                                :src="card.src"
                            ...
                            <v-card-actions>
                                <v-btn 
                                    ...
                                    outlined
                                >
                                    view <v-icon left>mdi-cube-scan</v-icon>
                                </v-btn>
                                 ...
                                 <v-btn
                                    ...
                                    outlined
                                >
                                    Read more <v-icon left>mdi-arrow-right</v-icon>
                                </v-btn>
...
<script>
import SWEEET_IMAGE from '@/assets/projects/sweeetonion.png';
  ...
  name: 'Projects',
    ...
    data: () => ({
        ...
        { 
            ...
            src: SWEEET_IMAGE,
            flex: 12,
            description: "Sweeet onion meets the modern terms of technologies and designs. Our development tools allow us to provide anspecial experience to online projects."
        },
        { 
            title: 'Sweeet onion',
            src: SWEEET_IMAGE,
